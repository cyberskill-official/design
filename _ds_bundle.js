...
function formatCurrency(n, langOrOpts) {
  ...
  return L === "vi" ? new Intl.NumberFormat("vi-VN").format(n) + " ₫" : "$" + new Intl.NumberFormat("en-US").format(n);
}
Object.assign(__ds_scope, { knownLocales, primaryLang, localeForLang, applyPseudo, resolveLang, tr, makeT, useLang, formatDate, formatPlural, monthName, formatNumber, formatCurrency });
...
const CONTRAST_VALUES = Object.freeze(["standard", "high"]);
const DENSITY_VALUES = Object.freeze(["comfortable", "compact"]);
...
Object.assign(__ds_scope, { THEME_VALUES, CONTRAST_VALUES, DENSITY_VALUES, resolveTheme, getThemeInitScript, useTheme, ThemeProvider });
...
Object.assign(__ds_scope, { nextRovingIndex, wrapIndex, reduceListbox });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/_utils/roving.js", error: String((e && e.message) || e) }); }
...
const Carousel = React.forwardRef(function Carousel2({ children, startIndex = 0, label, lang, className }, forwardedRef) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cs-carousel__view" }, /* @__PURE__ */ React.createElement("div", { className: "cs-carousel__track", style: { transform: "translateX(-" + i * 100 + "%)" } }, slides.map((s, j) => /* @__PURE__ */ React.createElement("div", { key: j, className: "cs-carousel__slide", role: "group", "aria-roledescription": "slide", "aria-hidden": j !== i, "aria-label": `${j + 1} / ${slides.length}` }, s))), /* @__PURE__ */ React.createElement("button", { type: "button", className: "cs-carousel__nav prev", "aria-label": t("prev"), onClick: () => go(-1) }, "‹"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "cs-carousel__nav next", "aria-label": t("next"), onClick: () => go(1) }, "›")),
...
const Sortable = React.forwardRef(function Sortable2({ items = [], onChange, lang, className }, forwardedRef) {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: forwardedRef, className: cx("cs-sortable-wrap", className) }, /* @__PURE__ */ React.createElement("div", { className: "cs-sr-only", "aria-live": "polite" }, live), /* @__PURE__ */ React.createElement("ul", { ref, className: "cs-sortable" }, items.map((it, idx) => /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("span", { className: "cs-sortable__label" }, it.label),
    /* @__PURE__ */ React.createElement("span", { className: "cs-sortable__ops", onMouseDown: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
...
const Cascader = React.forwardRef(function Cascader2({ nodes = [], value = EMPTY_PATH, onChange, placeholder, label, disabled = false, lang, className }, forwardedRef) {
  ...
  React.useEffect(() => {
    setPath(Array.isArray(value) ? value : EMPTY_PATH);
  }, [valueKey]);
  React.useEffect(() => {
    if (!open) return;
    const d = (e) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: (el) => {
    wrap.current = el;
    ref.current = el;
  }, className: cx("cs-cascader", className) }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      id: fieldId,
    ...
    /* @__PURE__ */ React.createElement("span", { className: labels.length ? void 0 : "ph" }, labels.length ? labels.join(" / ") : ph),
    /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "▾")
  ), open ? /* @__PURE__ */ React.createElement("div", { className: "cs-cascader__pop" }, cols.map((col, i) => /* @__PURE__ */ React.createElement("ul", { key: i, role: "listbox", "aria-labelledby": fieldId, className: "cs-cascader__col" }, col.map((n) => (
...
try { (() => {
const { mergeRefs } = __ds_scope;
const { reduceListbox } = __ds_scope;
const { makeT, useLang } = __ds_scope;
const { cx } = __ds_scope;
let cbUid = 0;
const Combobox = React.forwardRef(function Combobox2({ options = [], value, onChange, placeholder, label, disabled = false, lang, className }, forwardedRef) {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: mergeRefs(wrapRef, ref, forwardedRef), className: cx("cs-combobox", className) }, /* @__PURE__ */ React.createElement(
    "input",
    {
      role: "combobox",
      "aria-expanded": open,
...
const DatePicker = React.forwardRef(function DatePicker2({ value, onChange, placeholder, label, disabled = false, lang, className }, forwardedRef) {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: mergeRefs(wrap, ref, forwardedRef), className: cx("cs-datepicker", className) }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "cs-datepicker__field", disabled, "aria-haspopup": "dialog", "aria-expanded": open, "aria-label": label, onClick: () => setOpen((o) => !o) }, CAL_ICON, /* @__PURE__ */ React.createElement("span", { className: value ? void 0 : "ph" }, value ? formatDate(value, L) : ph)), open ? /* @__PURE__ */ React.createElement("div", { className: "cs-datepicker__pop", role: "dialog", "aria-label": label || ph }, /* @__PURE__ */ React.createElement(Calendar, { value, lang: L, onChange: (d) => {
    onChange && onChange(d);
    setOpen(false);
  } })) : null);
});
...
const Mentions = React.forwardRef(function Mentions2({ value, defaultValue = "", onChange, users = [], placeholder, rows = 3, lang, className }, forwardedRef) {
  ...
  ), open ? /* @__PURE__ */ React.createElement("span", { className: "cs-mentions__pop", role: "listbox", id: listId }, hits.map((u, i) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: u,
      type: "button",
...
try { (() => {
const { mergeRefs } = __ds_scope;
const { nextRovingIndex } = __ds_scope;
const { makeT, useLang } = __ds_scope;
const { cx } = __ds_scope;
...
const TagInput = React.forwardRef(function TagInput2({
  ...
  return /* @__PURE__ */ React.createElement("label", { ref: mergeRefs(ref, forwardedRef), className: cx("cs-field", disabled && "is-disabled", className), htmlFor: sid }, label ? /* @__PURE__ */ React.createElement("span", { className: "cs-field__label" }, label) : null, /* @__PURE__ */ React.createElement("div", { className: "cs-taginput" }, tags.map((tag) => /* @__PURE__ */ React.createElement("span", { key: tag, className: "cs-tag" }, tag, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.4", strokeLinecap: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M6 6l12 12M18 6L6 18" }))
  ))), /* @__PURE__ */ React.createElement(
    "input",
    {
      id: sid,
...
// components/forms/editor-schema.js
try { (() => {
...
Object.assign(__ds_scope, { EDITOR_SCHEMA, sanitizeHtml });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/forms/editor-schema.js", error: String((e && e.message) || e) }); }
...
const Toolbar = React.forwardRef(function Toolbar2({ items = [], overflowAfter, label, lang, className }, forwardedRef) {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: (el) => {
    wrap.current = el;
    ref.current = el;
  }, className: cx("cs-toolbar", className), role: "toolbar", "aria-label": label, "aria-orientation": "horizontal" }, head.map((it, i) => {
    if (it === "-") return /* @__PURE__ */ React.createElement("span", { key: "sep-" + i, className: "cs-toolbar__sep", "aria-hidden": "true" });
    const ci = controlI++;
    return /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      it.icon,
      it.label ? /* @__PURE__ */ React.createElement("span", null, it.label) : null
    );
  }), hasMore ? (() => {
    const ci = controlI++;
    return /* @__PURE__ */ React.createElement("span", { className: "cs-toolbar__more" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        className: "cs-toolbar__btn",
      ...
      "⋯"
    ), open ? /* @__PURE__ */ React.createElement("span", { className: "cs-menu__list", role: "menu" }, tail.map((it, i) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: i,
        type: "button",
...
function OverlayProvider({ children }) {
  ...
  return /* @__PURE__ */ React.createElement(OverlayContext.Provider, { value: api }, /* @__PURE__ */ React.createElement("div", { id: "cs-overlay-root", "data-cs-overlay-root": "" }), children);
}
...
Object.assign(__ds_scope, { focusableSelector, attachFocusTrap, applySiblingInert, getOverlayManager, OverlayProvider, useOverlayLayer, ThemeProvider, useTheme, getThemeInitScript });
...
const Drawer = React.forwardRef(function Drawer2({ open, onClose, title, side = "right", children, actions, lang, className }, forwardedRef) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { ref: forwardedRef, className: "cs-drawer-scrim", onClick: onClose, "aria-hidden": "true" }), /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cs-drawer__header" }, title ? /* @__PURE__ */ React.createElement("h2", { className: "cs-drawer__title" }, title) : null, /* @__PURE__ */ React.createElement("button", { type: "button", className: "cs-drawer__close", "aria-label": t("close"), onClick: onClose }, /* @__PURE__ */ React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M6 6l12 12M18 6L6 18" })))),
...
const tokens = {
  ...
  "root": {
    ...
    "text": {
      ...
      "--cs-text-micro": "var(--cs-font-size-2xs)",
  ...
  "elements": {
    ...
    "hoa.lava": {
      ...
      "--cs-accent-grad-a": "#622B06",
      "--cs-accent-grad-b": "#F4BA17",
      "--cs-color-text-accent": "#280D00",
      "--cs-color-link": "#280D00"
    },
    "thuy.mist": {
      "--cs-accent": "#C0F5FC",
...
__ds_ns.DENSITY_VALUES = __ds_scope.DENSITY_VALUES;
...
__ds_ns.EDITOR_SCHEMA = __ds_scope.EDITOR_SCHEMA;
