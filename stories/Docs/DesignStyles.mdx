...
Current surface treatment is **liquid-glass** (fixed). The live styling axes are **Theme × Element × Language × Style** only.
...
Do not invent a fourth product axis without an Expansion Rule pass across tokens, Storybook, templates, docs, and gates.

See also **Foundations → Elements** and **Docs → The Four Axes**.
