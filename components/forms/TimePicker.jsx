...
export const TimePicker = React.forwardRef(function TimePicker({ value = "09:00", onChange, step = 30, label, disabled = false, lang, className }, forwardedRef) {
  ...
  return (
    <span ref={mergeRefs(ref, forwardedRef)} className={cx("cs-timepicker", className)}>
      {CLOCK}
