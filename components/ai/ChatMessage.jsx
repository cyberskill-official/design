 ...
 */
export const ChatMessage = React.forwardRef(function ChatMessage({ role = "lumi", name, avatar, lang, className, children }, forwardedRef) {
  ...
  return (
    <div ref={mergeRefs(ref, forwardedRef)} className={cx("cs-chat-msg", isUser ? "cs-chat-msg--user" : "cs-chat-msg--lumi", className)}>
