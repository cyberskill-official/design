...
export const ProgressBar = React.forwardRef(function ProgressBar({ value = 0, max = 100, variant, label, lang, className }, forwardedRef) {
  ...
  return (
    <div ref={mergeRefs(ref, forwardedRef)} className={cx("cs-progress", variant && `cs-progress--${variant}`, className)}
