...
# TASK-IMP-025: Enterprise audit remediations
...
- [x] AC for 1.2 — `LICENSE` + decisions §14 + resolved deck-stage notice
...
- Do not reintroduce Density/Expression as a product axis (`axis-guard`).
