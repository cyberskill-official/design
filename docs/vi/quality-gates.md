...
| Component behavior | `_audit/component-behavior-test.html` | 46 assert tương tác thật — toggle, controlled selection, lọc palette, overlay open/close, Form rules, Tree/Splitter/keyboard, Wave-2 Item/NativeSelect/AlertDialog/Collapsible, Tooltip/HoverCard/ContextMenu, Slider/Select, TreeTable expand, InputGroup clear+password | 46/46 assert pass (`__behavior`) | Hard | Fast board CI |
