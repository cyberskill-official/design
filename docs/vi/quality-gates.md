...
| Component behavior | `_audit/component-behavior-test.html` | 39 assert tương tác thật — toggle, controlled selection, lọc palette, overlay open/close, Form rules, Tree/Splitter/keyboard, Wave-2 Item/NativeSelect/AlertDialog/Collapsible | 39/39 assert pass (`__behavior`) | Hard | Fast board CI |
