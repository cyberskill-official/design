...
| Component behavior | `_audit/component-behavior-test.html` | 60 assert tương tác thật — toggle, overlay, Form rules, Tree/picker, Tooltip/HoverCard/ContextMenu, Slider/Select, TreeTable, InputGroup, Menubar…FileUpload, cộng NavigationMenu, NavItem, PromptInput, Tag, Dock, TextField, Textarea | 60/60 assert pass (`__behavior`) | Hard | Fast board CI |
