...
| Component behavior | `_audit/component-behavior-test.html` | 53 assert tương tác thật — toggle, overlay, Form rules, Tree/picker, Tooltip/HoverCard/ContextMenu, Slider/Select, TreeTable, InputGroup, Menubar, Toast, RadioGroup, NumberField, SearchField, TimePicker, FileUpload | 53/53 assert pass (`__behavior`) | Hard | Fast board CI |
