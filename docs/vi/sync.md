...
- **`VERSION` đã LAUNCH ở 1.1.0; pin hiện tại **1.1.1**** — chỉ bump khi có chỉ thị owner rõ; không maintain file changelog. Continuity là git history; việc maintainer đang mở nằm ở `docs/decisions.md`.
