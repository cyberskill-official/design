...
## Fast board — 32 gates in `_audit/run.html`
...
| Axe smoke | `_audit/axe-smoke.html` | axe-core 4.10.0 (vendored at `_audit/vendor/axe.min.js`) serious/critical WCAG 2 A/AA rules on a 30-component bilingual cross-group cluster (forms · overlays · navigation · feedback · data · datatable · dialog · ai · brand · button · textfield · icon · logo); gate-equivalent Storybook a11y enforcement (no separate test-runner) | 0 serious/critical findings (`__axesmoke`) | Hard | Fast board CI |
