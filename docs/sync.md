...
- **`VERSION` is LAUNCHED at 1.1.0** — bump only with an explicit owner instruction; do not maintain a changelog file. Continuity is the git history; open maintainer tasks live in `docs/decisions.md`.
