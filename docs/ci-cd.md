...
11. **`inclusive-matrix`** — Chromium smoke of 320 / forced-colors / reduced-motion / RTL / pseudo-locale on every PR; nightly and `workflow_dispatch` also install Firefox and WebKit (`_audit/ci/inclusive-matrix.mjs`). Policy: `docs/support-matrix.md`.
