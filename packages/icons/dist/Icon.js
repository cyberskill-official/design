...
var Icon = React.forwardRef(function Icon2({ name, size = "md", label, className, strokeWidth = 1.75, ...props }, forwardedRef) {
  ...
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      ...a11y,
      children: def.els.map(([tag, attrs], i) => React.createElement(tag, { key: i, ...attrs }))
    }
  );
});
export {
