 ...
 *
 *  Trust boundary (CDS-SEC-001): `defaultValue`, controlled `value`, and emitted
 *  HTML are sanitized to `EDITOR_SCHEMA` allowlisted tags (no attributes). Use
 *  `unsafeHtml` only for trusted markup that must bypass sanitization. */
...
/** Allowlisted tags for Editor HTML (TASK-IMP-029 schema model). */
...
export const Editor: React.ForwardRefExoticComponent<
  EditorProps & React.RefAttributes<HTMLElement>
>;
